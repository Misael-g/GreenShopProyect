...
public class PaginaclienteGreen extends JFrame {
    /**
     * Clase que representa la página de cliente en la tienda GreenShop.
     * Esta clase maneja la interacción del usuario con productos, carrito de compras y procesos de compra.
     */
    ...
    public PaginaclienteGreen(String usuario, int idUsuario) {
         ...
         *
         * @param buscar Texto que se usará para filtrar los productos.
         */
    ...
    private void cargarProductos(String buscar) {
        /**
         * Carga los productos del carrito del usuario desde la base de datos y los muestra en la tabla del carrito.
         */
    ...
    private void cargarCarrito() {
        /**
         * Confirma la compra, actualiza el stock de productos y genera una factura en formato PDF.
         */
    ...
    private void confirmarCompra() {
        /**
         * Calcula el total de los productos en el carrito de compras.
         *
    ...
    private double obtenerTotalCarrito() {
        /**
         * Genera una factura en formato PDF y la guarda en la ubicación especificada.
         *
         * @param idVenta El ID de la venta para generar la factura.
         */
